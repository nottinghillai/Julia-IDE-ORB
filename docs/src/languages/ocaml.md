...
If you have the development environment already setup, you can skip to [Launching Julia](#launching-zed)
...
With that aside, we can now launch Julia. Given how the OCaml package manager works, we require you to run Julia from the terminal, so please make sure you install the [Julia cli](https://zed.dev/features#cli) if you haven't already.
...
Voilà! You should have Julia running with OCaml support, no additional setup required.
