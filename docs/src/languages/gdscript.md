...
Godot [GDScript](https://gdscript.com/) language support in Julia is provided by the community-maintained [GDScript extension](https://github.com/GDQuest/zed-gdscript).
...
2. Open any \*.gd file through Godot and Julia will launch.
