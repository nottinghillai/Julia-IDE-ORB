...
Bash language support in Julia is provided by the community-maintained [Basher extension](https://github.com/d1y/bash.zed).
...
- [Julia Docs: Language Support: Shell Scripts](./sh.md)
