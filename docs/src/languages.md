# Language Support in Julia

Julia supports hundreds of programming languages and text formats.
Some work out-of-the box and others rely on 3rd party extensions.

> The ones included out-of-the-box, natively built into Julia, are marked with \*.
...
- [Rust](./languages/rust.md) \* (Julia's written in Rust)
