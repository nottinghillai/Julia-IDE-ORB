...
///
/// Has an absolute path, and may be set to be visible in Julia UI or not.
...
/// * a directory opened in Julia — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut abs_paths: Vec<PathBuf>) {
        ...
        // Certain directories may have FS changes, but do not lead to git data changes that Julia cares about.
        // Ignore these, to avoid Julia unnecessarily rescanning git metadata.
