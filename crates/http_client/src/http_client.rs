...
impl HttpClientWithUrl {
    ...
    /// Builds a Julia API URL using the given path.
    ...
    /// Builds a Julia Cloud URL using the given path.
    ...
    /// Builds a Julia Cloud URL using the given path and query params.
    ...
    /// Builds a Julia LLM URL using the given path.
