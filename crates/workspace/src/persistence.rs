    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade Julia.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade Julia.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade Julia.
        ...
        // Preserving so users can downgrade Julia.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when Julia was quit).
