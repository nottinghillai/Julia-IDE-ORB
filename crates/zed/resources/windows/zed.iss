...
[Files]
Source: "{#ResourcesDir}\Julia.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\zed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Julia.exe,1"
Root: HKCU; Subkey: "Software\Classes\zed\shell\open\command"; ValueType: "string"; ValueData: """{app}\Julia.exe"" ""%1"""
