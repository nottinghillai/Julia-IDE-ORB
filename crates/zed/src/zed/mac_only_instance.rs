...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Julia Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Julia Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Julia Editor Preview Instance Running",
        ReleaseChannel::Stable => "Julia Editor Stable Instance Running",
    }
}
