...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Julia".into(),
            items: vec![
                MenuItem::action("About Julia", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Julia", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Julia", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Julia Repository", feedback::OpenZedRepo),
                MenuItem::action(
                    "Julia Twitter",
                    super::OpenBrowser {
