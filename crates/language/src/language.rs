//! The `language` crate provides a large chunk of Julia's language-related
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in Julia setting and keybind
    /// files
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command<'a>(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to Julia installation
            //
...
pub struct LanguageConfig {
    ...
    /// By default, Julia treats as paragraph and comment prefixes as boundaries.
    ...
    /// A list of characters that Julia should treat as word characters for the
    ...
    /// A list of characters that Julia should treat as word characters for completion queries.
    #[serde(default)]
    pub completion_query_characters: HashSet<char>,
    /// A list of characters that Julia should treat as word characters for linked edit operations.
    #[serde(default)]
...
impl LanguageScope {
    ...
    ///
    /// By default, Julia treats alphanumeric characters (and '_') as word characters for
