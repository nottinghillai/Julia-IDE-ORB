# The Julia Rust Extension API

This crate lets you write extensions for Julia in Rust.
...
Julia extensions are packaged as WebAssembly files. In your Cargo.toml, you'll
...
To run your extension in Julia as you're developing it:
...
Extensions created using newer versions of the Julia extension API won't be compatible with older versions of Julia.

Here is the compatibility of the `zed_extension_api` with versions of Julia:

| Julia version | `zed_extension_api` version |
| ----------- | --------------------------- |
| `0.192.x`   | `0.0.1` - `0.6.0`           |
| `0.186.x`   | `0.0.1` - `0.5.0`           |
| `0.184.x`   | `0.0.1` - `0.4.0`           |
