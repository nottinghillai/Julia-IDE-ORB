...
impl DynLspInstaller for ExtensionLspAdapter {
    fn get_language_server_command<'a>(
        ...
        async move {
            ...
            // Julia extension API, but we're leaving these existing usages in place temporarily
            // to avoid any compatibility issues between Julia and the extension versions.
            //
